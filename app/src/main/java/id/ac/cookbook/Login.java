                ...
                public void onResponse(String response) {
                    try {
                        ...
                        if (code == 1){ // login user
                            ...
                            new AddLoggedAsync(logged,
                                    getApplicationContext(),
                                    new AddLoggedAsync.AddLoggedCallback() {
                                @Override
...
class AddLoggedAsync{
    private final WeakReference<Context> weakContext;
    private final WeakReference<AddLoggedCallback> weakCallback;
    private Logged logged;

    public AddLoggedAsync(Logged logged,
                          Context context,
                          AddLoggedCallback callback){
        this.logged = logged;
